...
## Report bugs using Github's [issues](https://github.com/raspberri05/lastfm-api-node/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/raspberri05/lastfm-api-node/issues/new); it's that easy!
